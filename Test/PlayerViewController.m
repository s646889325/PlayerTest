...
- (void)viewDidLoad {
    ...
    self.activity.center = _backView.center;
...
- (void)createSlider{
    ...
    self.slider = [[UISlider alloc]initWithFrame:CGRectMake((_width - _width * 0.69) / 2 - 2, _height - 15 - 7, _width * 0.7, 15)];
...
- (void)createProgress{
   ...
   self.progress = [[UIProgressView alloc]initWithFrame:CGRectMake((_width - _width * 0.69) / 2 , _height - 15, _width * 0.69, 15)];
...
- (void)createCurrentTimeLabel{
    ...
    self.currentTimeLabel = [[UILabel alloc]initWithFrame:CGRectMake(_width *0.86, _height - 25, 100, 20)];
...
- (void)createButton{
    ...
    startButton.frame = CGRectMake(15, _height - 30, 30, 30);
